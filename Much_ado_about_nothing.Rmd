...
Under all 3 conditions of missing data, we will be artificialy removing 30% of their data. This will be achieved using the `missMethods` package.  
...
vis_MNAR <- ggplot(MNAR_iris, aes(x = Sepal.Length, y = Petal.Length)) + # Using Sepal.Width  to examine here
  geom_point()+
  geom_smooth(method = "lm") +
  geom_miss_point() + # using grid_miss_point() from earlier to view difference
  theme(legend.position = "bottom") +
...
vis_MNAR_delete <- ggplot(delete_MNAR, aes(x = Sepal.Length, y = Petal.Length, color = )) +
  geom_point()+
  geom_smooth(method = "lm") +
  geom_miss_point() + # using grid_miss_point() from earlier to view difference
  theme(legend.position = "bottom") +
...
vis_mean_imp <- ggplot(mean_imp_MNAR, aes(x = Sepal.Length, y = Petal.Length, color = Petal.Length_NA)) +
  geom_point()+
  geom_smooth(method = "lm") +
  geom_miss_point() + # using grid_miss_point() from earlier to view difference
  theme(legend.position = "bottom") +
...
vis_lm_imp <- ggplot(lm_imp_MNAR, aes(x = Sepal.Length, y = Petal.Length, color = Petal.Length_NA)) +
  geom_point()+
  geom_smooth(method = "lm") +
  geom_miss_point() + # using grid_miss_point() from earlier to view difference
  theme(legend.position = "bottom") +
...
vis_pmm_imp <- ggplot(pmm_MNAR_complete, aes(x = Sepal.Length, y = Petal.Length, color = Petal.Length_NA)) +
  geom_point()+
  geom_smooth(method = "lm") +
  geom_miss_point() + # using grid_miss_point() from earlier to view difference
  theme(legend.position = "bottom") +
...
vis_rescue_imp <- ggplot(pmm_rescue_complete, aes(x = Sepal.Length, y = Petal.Length, color = Petal.Length_NA)) +
  geom_point()+
  geom_smooth(method = "lm") +
  geom_miss_point() + # using grid_miss_point() from earlier to view difference
  theme(legend.position = "bottom") +
  labs(title = "MNAR missing values with auxillary variatble (Petal.Width)", 
       subtitle =  "Petal.Length imputed via pmm")

grid.arrange(vis_rescue_imp, vis_pmm_imp) # Using grid.arrange() to compare plots, lets see the difference between a full data, and MCAR data
