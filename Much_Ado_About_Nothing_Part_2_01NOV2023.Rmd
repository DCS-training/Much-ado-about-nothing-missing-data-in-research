...
imp4 <- mice(nhanes_new, m = 10 , maxit = 10,
             meth = c("", "norm", "rf", "norm"), print = FALSE
             )
...
life_events <- read_csv("~/CDCS/Much ado about nothing/Lifeevents.csv")
...
imp <-mice(MAR_lifeevents, 
                  ...
                  "pmm", "pmm", "pmm"), 
            seed = 123, print = FALSE, pred = quickpred(MAR_lifeevents, mincor = .2), m =10)
